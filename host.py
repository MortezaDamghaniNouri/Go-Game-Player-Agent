...
def go_game(input_my_stone_color, input_previous_board, input_current_board):
    ...
    if input_my_stone_color == 1:
        ...
        all_legal_points = eyes_points_remover()
...
while True:
    ...
    all_legal_points = suicide_points_remover(white_player_all_empty_points, 2, current_board)
    all_legal_points = KO_rule_applier(all_legal_points, current_board, previous_board, 2)
